...
export const initialScreenerStocks = [
  ...
  { ticker: "BBAS3", name: "Banco do Brasil ON", price: 41.20, pl: 5.3, roe: 19.8, divYield: 7.5, marketCap: 118.2, evEbitda: 4.5, debtEquity: 0.4, dlEbitda: 0.22, netMargin: 16.80, liquidity: 95000000, vpv: 0.85, lpa: 7.77, vpa: 48.47, growthRate: 10.0, sector: "Financeiro", var12m: 29.40 },
